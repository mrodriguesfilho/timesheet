...
public static class EmployeeProjectsQueries
{
    ...
    public static string SELECT_EMPLOYEE_ALLOCATED_PROJECTS_BY_ID_EMPLOYEE = "select id_employee, id_project, dt_allocated, dt_deallocated from mowdb.tb_employee_project where dt_deallocated is null and id_employee = {0}";
}